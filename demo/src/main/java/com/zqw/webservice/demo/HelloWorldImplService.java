 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://demo.webservice.zqw.com/", wsdlLocation = "http://localhost:8788/helloworld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://demo.webservice.zqw.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8788/helloworld?wsdl");
    ...
    public HelloWorldImpl getHelloWorldImplPort() {
        return super.getPort(new QName("http://demo.webservice.zqw.com/", "HelloWorldImplPort"), HelloWorldImpl.class);
    }
    ...
    public HelloWorldImpl getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://demo.webservice.zqw.com/", "HelloWorldImplPort"), HelloWorldImpl.class, features);
    }
