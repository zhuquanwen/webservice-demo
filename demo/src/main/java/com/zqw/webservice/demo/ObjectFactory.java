 ...
 * generated in the com.zqw.webservice.demo package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHelloWorldResponse_QNAME = new QName("http://demo.webservice.zqw.com/", "sayHelloWorldResponse");
    private final static QName _SayHelloWorld_QNAME = new QName("http://demo.webservice.zqw.com/", "sayHelloWorld");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.zqw.webservice.demo
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://demo.webservice.zqw.com/", name = "sayHelloWorldResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://demo.webservice.zqw.com/", name = "sayHelloWorld")
